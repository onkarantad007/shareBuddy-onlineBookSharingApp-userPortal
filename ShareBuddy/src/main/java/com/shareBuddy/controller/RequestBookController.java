...
public class RequestBookController {
	...
	public String addBookPost(@ModelAttribute("reqbook") ReqBook book, HttpServletRequest request, Model model,Principal principal
		...
		try {
			...
			BufferedOutputStream stream = new BufferedOutputStream(new FileOutputStream(new java.io.File("/home/luffy/Documents/Java-Workbench/project_workspace/share_buddy_images/"+name))); //ADMIN SIDE
 			stream.write(bytes);
			stream.close();
